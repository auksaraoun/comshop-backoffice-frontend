...
export function ProductType() {
    ...
    const { data, isError, isFetched } = useQuery({
        queryKey: ['ProductTypesTable', params],
        queryFn: () => fetchProductTypes(params),
        ...
        <div className="container mx-auto">
            ...
            <div className="flex mb-10 md:mb-5 justify-between flex-wrap gap-y-8" >
                ...
                <div className="w-full md:max-w-58" >
                    <ProductTypeFilter params={params} setParams={setParams} />
                </div>
            </div>
            ...
            {!isError && data && isFetched && (
                <CustomDataTable columns={productTypeColumn} data={data} params={params} setParams={setParams} />
            )}
        </div>
    )
}