...
export function ProductTypeDelete({ productType }: { productType: ProductType }) {
    const queryClient = useQueryClient()
    const { mutate, isPending } = useMutation({
        mutationFn: async () => {
            await api.delete(`/api/product-types/${productType.id}`)
        },
        onSuccess: () => {
        ...
        <AlertDialog>
            ...
            <AlertDialogContent size="sm">
                <AlertDialogHeader>
                    ...
                    <AlertDialogTitle>คุณต้องการลบ Product Type นี้ใช่หรือไม่?</AlertDialogTitle>
                    <AlertDialogDescription>
